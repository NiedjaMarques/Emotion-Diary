...
import backgroundImage from '../../public/view/bg5.png'
        ...
        <>
            <MainLayout>                
                <div >
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2  gap-5 py-5'> {/* md:grid-cols-4 */}

                        <Link to="/diariodedesejos">
